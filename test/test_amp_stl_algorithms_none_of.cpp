...
*
* This file contains unit tests for the none_of algorithm.
*---------------------------------------------------------------------------*/
...
class stl_algorithms_none_of_tests : public stl_algorithms_testbase<13>,
									 public ::testing::Test {};

TEST_F(stl_algorithms_none_of_tests, none_of_all_values)
{
	...
	const auto result_expect = std::none_of(cbegin(input_av), cend(input_av), p);
	const auto result_amp = amp_stl_algorithms::none_of(cbegin(input_av), cend(input_av), p);

	ASSERT_EQ(result_expect, result_amp);
}

TEST_F(stl_algorithms_none_of_tests, none_of_some_values)
{
	using namespace amp_stl_algorithms;
	...
	const auto result_expect = std::none_of(cbegin(in_av), cend(in_av), p);
	const auto result_amp = amp_stl_algorithms::none_of(cbegin(in_av), cend(in_av), p);

	ASSERT_EQ(result_expect, result_amp);
}

TEST_F(stl_algorithms_none_of_tests, none_of_no_values)
{
	using namespace amp_stl_algorithms;
...
TEST_F(stl_algorithms_none_of_tests, none_of_empty_range)
{
	using namespace amp_stl_algorithms;

	const auto p = [](auto&&) restrict(cpu, amp) { return true; };
	const auto result_expect = std::none_of(cbegin(input_av), cbegin(input_av), p);
	const auto result_amp = amp_stl_algorithms::none_of(cbegin(input_av), cbegin(input_av), p);

	ASSERT_EQ(result_expect, result_amp);
}

TEST_F(stl_algorithms_none_of_tests, none_of_single_element_range_true)
{
	using namespace amp_stl_algorithms;

	const auto v = std::numeric_limits<decltype(input_av)::value_type>::max();
	const auto p = [=](auto&& x) restrict(cpu, amp) { return x < v; };
	const auto result_expect = std::none_of(cbegin(input_av), std::next(cbegin(input_av)), p);
	const auto result_amp = amp_stl_algorithms::none_of(cbegin(input_av),
														std::next(cbegin(input_av)),
														p);
	ASSERT_EQ(result_expect, result_amp);
}

TEST_F(stl_algorithms_none_of_tests, none_of_single_element_range_false)
{
	using namespace amp_stl_algorithms;
...
TEST_F(stl_algorithms_none_of_tests, none_of_all_values_large_range)
{
	using namespace amp_stl_algorithms;
...
TEST_F(stl_algorithms_none_of_tests, none_of_some_values_large_range)
{
	using namespace amp_stl_algorithms;
...
TEST_F(stl_algorithms_none_of_tests, none_of_no_values_large_range)
{
	using namespace amp_stl_algorithms;
