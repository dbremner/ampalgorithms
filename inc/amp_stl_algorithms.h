...
namespace amp_stl_algorithms
{
    ...
    public:
        ...
        pair(const T1& val1, const T2& val2) restrict(cpu, amp)
            : first(val1), second(val2)
        { }
        pair(T1&& val1, T2&& val2) restrict(cpu, amp)
            : first(forward<T1>(val1)), second(forward<T2>(val2))
        { }

        template<class Other1, class Other2>
        pair(const pair<Other1, Other2>& _Right) restrict(cpu, amp)
            : first(_Right.first), second(_Right.second)
        { }

        template<class Other1, class Other2>
        pair(Other1&& val1, Other2&& val2) restrict(cpu, amp)
            : first(forward<Other1>(val1)), second(forward<Other2>(val2))
        { }

        // Support interop with std::pair.

        pair(const std::pair<T1, T2>& val) restrict(cpu, amp)
            : first(val.first), second(val.second)
        { }
        template<typename U1, typename U2>
        pair(const std::pair<U1, U2>& val) restrict(cpu, amp)
            : first(val.first), second(val.second)
        { }
        pair(std::pair<T1, T2>&& val) restrict(cpu, amp)
            : first(forward<T1>(val.first)), second(forward<T2>(val.second))
        { }
        template<typename U1, typename U2>
        pair(std::pair<U1, U2>&& val) restrict(cpu, amp)
            : first(forward<U1>(val.first)), second(forward<U2>(val.second))
        { }

        pair& operator=(const std::pair<T1, T2>& val) restrict(cpu, amp)
        {
            first = val.first;
            second = val.second;
            return *this;
        }
        pair& operator=(std::pair<T1, T2>&& val) restrict(cpu, amp)
        {
            first = forward<T1>(val.first);
            second = forward<T2>(val.second);
            return *this;
        }
    ...
    template<class T1, class T2>
    inline bool operator==(const pair<T1, T2>& _Left, const pair<T1, T2>& _Right) restrict(cpu, amp)
    {
    ...
    */
    ...
    RandomAccessIterator adjacent_difference(ConstRandomAccessIterator first, ConstRandomAccessIterator last, RandomAccessIterator dest_first);

    template<typename ConstRandomAccessIterator,typename RandomAccessIterator, typename BinaryOperation>
    RandomAccessIterator adjacent_difference(ConstRandomAccessIterator first, ConstRandomAccessIterator last, RandomAccessIterator dest_first, BinaryOperation&& op);
    ...
    RandomAccessIterator copy_if(ConstRandomAccessIterator first, ConstRandomAccessIterator last, RandomAccessIterator dest_first, UnaryPredicate&& p);
    ...
    // TODO_NOT_IMPLEMENTED: copy_backward, does copy_backward really make any sense on a data-parallel context? Yes it does, consider backward overlap.
    template<typename ConstRandomAccessIterator, typename RandomAccessIterator>
    RandomAccessIterator copy_backward(ConstRandomAccessIterator first, ConstRandomAccessIterator last, RandomAccessIterator d_last);
    ...
    Difference_type<ConstRandomAccessIterator> count(ConstRandomAccessIterator first, ConstRandomAccessIterator last, T&& value);

    template<typename ConstRandomAccessIterator, typename UnaryPredicate>
    Difference_type<ConstRandomAccessIterator> count_if(ConstRandomAccessIterator first, ConstRandomAccessIterator last, UnaryPredicate&& p);
    ...
    bool equal( ConstRandomAccessIterator1 first1, ConstRandomAccessIterator1 last1, ConstRandomAccessIterator2 first2, BinaryPredicate&& p);

    template<typename ConstRandomAccessIterator, typename T>
    std::pair<ConstRandomAccessIterator, ConstRandomAccessIterator> equal_range(ConstRandomAccessIterator first, ConstRandomAccessIterator last, T&& value);

    template<typename ConstRandomAccessIterator, typename T, typename Compare>
    std::pair<ConstRandomAccessIterator, ConstRandomAccessIterator> equal_range(ConstRandomAccessIterator first, ConstRandomAccessIterator last, T&& value, Compare&& comp);
    ...
    void fill(RandomAccessIterator first, RandomAccessIterator last, T&& value);

    template<typename RandomAccessIterator, typename Size, typename T>
    RandomAccessIterator fill_n(RandomAccessIterator first, Size count, T&& value);
    ...
    template<typename ConstRandomAccessIterator, typename T>
    ConstRandomAccessIterator find(ConstRandomAccessIterator first, ConstRandomAccessIterator last, T&& value);
    ...
    template<typename ConstRandomAccessIterator1, typename ConstRandomAccessIterator2>
    ConstRandomAccessIterator1 find_end(ConstRandomAccessIterator1 first1, ConstRandomAccessIterator1 last1, ConstRandomAccessIterator2 first2, ConstRandomAccessIterator2 last2);

    template<typename ConstRandomAccessIterator1, typename ConstRandomAccessIterator2, typename Predicate>
    ConstRandomAccessIterator1 find_end(ConstRandomAccessIterator1 first1, ConstRandomAccessIterator1 last1, ConstRandomAccessIterator2 first2, ConstRandomAccessIterator2 last2, Predicate&& p);

    // TODO_NOT_IMPLEMENTED: find_first_of
    template<typename ConstRandomAccessIterator1, typename ConstRandomAccessIterator2>
    ConstRandomAccessIterator1 find_first_of(ConstRandomAccessIterator1 first1, ConstRandomAccessIterator1 last1, ConstRandomAccessIterator2 first2, ConstRandomAccessIterator2 last2);

    template<typename ConstRandomAccessIterator1, typename ConstRandomAccessIterator2, typename Predicate>
    ConstRandomAccessIterator1 find_first_of(ConstRandomAccessIterator1 first1, ConstRandomAccessIterator1 last1, ConstRandomAccessIterator2 first2, ConstRandomAccessIterator2 last2, Predicate&& p);
    ...
    template<typename ConstRandomAccessIterator1, typename ConstRandomAccessIterator2>
    bool includes(ConstRandomAccessIterator1 first1, ConstRandomAccessIterator1 last1, ConstRandomAccessIterator2 first2, ConstRandomAccessIterator2 last2);

    template<typename ConstRandomAccessIterator1, typename ConstRandomAccessIterator2, typename Compare>
    bool includes(ConstRandomAccessIterator1 first1, ConstRandomAccessIterator1 last1, ConstRandomAccessIterator2 first2, ConstRandomAccessIterator2 last2, Compare&& comp);
    ...
    T inner_product(ConstRandomAccessIterator1 first1, ConstRandomAccessIterator1 last1, ConstRandomAccessIterator2 first2, T&& value);
    ...
    T inner_product(ConstRandomAccessIterator1 first1, ConstRandomAccessIterator1 last1, ConstRandomAccessIterator2 first2, T&& value, BinaryOperation1&& binary_op1, BinaryOperation2&& binary_op2);
    ...
    template<typename ConstRandomAccessIterator1, typename ConstRandomAccessIterator2>
    bool lexicographical_compare(ConstRandomAccessIterator1 first1, ConstRandomAccessIterator1 last1, ConstRandomAccessIterator2 first2, ConstRandomAccessIterator2 last2);

    template<typename ConstRandomAccessIterator1, typename ConstRandomAccessIterator2, typename Compare>
    bool lexicographical_compare(ConstRandomAccessIterator1 first1, ConstRandomAccessIterator1 last1, ConstRandomAccessIterator2 first2, ConstRandomAccessIterator2 last2, Compare&& comp);
	...
	template<typename ConstRandomAccessIterator1, typename ConstRandomAccessIterator2, typename BinaryPredicate>
	bool is_permutation(ConstRandomAccessIterator1 first1, ConstRandomAccessIterator1 last1, ConstRandomAccessIterator2 first2, BinaryPredicate&& p);

	template<typename ConstRandomAccessIterator1, typename ConstRandomAccessIterator2>
	bool is_permutation(ConstRandomAccessIterator1 first1, ConstRandomAccessIterator1 last1, ConstRandomAccessIterator2 first2);
    ...
    template<typename ConstRandomAccessIterator, typename T>
	ConstRandomAccessIterator lower_bound(ConstRandomAccessIterator first, ConstRandomAccessIterator last, T&& value);

    template<typename ConstRandomAccessIterator, typename T, typename Compare>
    ConstRandomAccessIterator lower_bound( ConstRandomAccessIterator first, ConstRandomAccessIterator last, T&& value, Compare&& comp);

    template<typename ConstRandomAccessIterator, typename T>
    ConstRandomAccessIterator upper_bound( ConstRandomAccessIterator first, ConstRandomAccessIterator last, T&& value);

    template<typename ConstRandomAccessIterator, typename T, typename Compare>
    ConstRandomAccessIterator upper_bound( ConstRandomAccessIterator first, ConstRandomAccessIterator last, T&& value, Compare&& comp);
	...
	RandomAccessIterator merge(ConstRandomAccessIterator1 first1, ConstRandomAccessIterator1 last1, ConstRandomAccessIterator2 first2, ConstRandomAccessIterator2 last2, RandomAccessIterator dest_first, BinaryPredicate&& comp);

    template<typename ConstRandomAccessIterator1, typename ConstRandomAccessIterator2,typename RandomAccessIterator>
    RandomAccessIterator merge(ConstRandomAccessIterator1 first1, ConstRandomAccessIterator1 fast1, ConstRandomAccessIterator2 first2, ConstRandomAccessIterator2 last2, RandomAccessIterator dest_first);
    ...
    void inplace_merge(RandomAccessIterator first, RandomAccessIterator middle, RandomAccessIterator last, Compare&& comp);
    ...
    template<typename ConstRandomAccessIterator>
    std::pair<ConstRandomAccessIterator,ConstRandomAccessIterator> minmax_element(ConstRandomAccessIterator first, ConstRandomAccessIterator last);

    template<typename ConstRandomAccessIterator, typename Compare>
    std::pair<ConstRandomAccessIterator,ConstRandomAccessIterator> minmax_element(ConstRandomAccessIterator first, ConstRandomAccessIterator last, Compare&& comp);
    ...
    template<typename ConstRandomAccessIterator1, typename ConstRandomAccessIterator2>
    std::pair<ConstRandomAccessIterator1, ConstRandomAccessIterator2> mismatch(ConstRandomAccessIterator1 first1, ConstRandomAccessIterator1 last1, ConstRandomAccessIterator2 first2);

    template<typename ConstRandomAccessIterator1, typename ConstRandomAccessIterator2, typename BinaryPredicate>
    std::pair<ConstRandomAccessIterator1,ConstRandomAccessIterator2> mismatch(ConstRandomAccessIterator1 first1, ConstRandomAccessIterator1 last1, ConstRandomAccessIterator2 first2, BinaryPredicate&& p);
    ...
    template<typename ConstRandomAccessIterator, typename RandomAccessIterator>
    RandomAccessIterator move(ConstRandomAccessIterator first, ConstRandomAccessIterator last, RandomAccessIterator d_first);

    // TODO_NOT_IMPLEMENTED: move_backward, does move_backward really make any sense on a data-parallel context?
    template<typename ConstRandomAccessIterator, typename RandomAccessIterator>
    RandomAccessIterator move_backward(ConstRandomAccessIterator first, ConstRandomAccessIterator last, RandomAccessIterator d_last);
	...
	T reduce(ConstRandomAccessIterator first, ConstRandomAccessIterator last, T&& identity_element, BinaryOperation&& op);
    ...
    template<typename RandomAccessIterator, typename T>
    RandomAccessIterator remove(RandomAccessIterator first, RandomAccessIterator last, T&& value);
    ...
    RandomAccessIterator remove_copy(ConstRandomAccessIterator first, ConstRandomAccessIterator last, RandomAccessIterator dest_first, T&& value);

    template<typename ConstRandomAccessIterator,typename RandomAccessIterator, typename UnaryPredicate>
    RandomAccessIterator remove_copy_if(ConstRandomAccessIterator first, ConstRandomAccessIterator last, RandomAccessIterator dest_first, UnaryPredicate&& p);
    ...
    template<typename RandomAccessIterator, typename T>
    void replace(RandomAccessIterator first, RandomAccessIterator last, T&& old_value, T&& new_value);

    template<typename RandomAccessIterator, typename UnaryPredicate, typename T>
    void replace_if(RandomAccessIterator first, RandomAccessIterator last, UnaryPredicate&& p, T&& new_value);

    template<typename ConstRandomAccessIterator,typename RandomAccessIterator, typename T>
    RandomAccessIterator replace_copy(ConstRandomAccessIterator first, ConstRandomAccessIterator last, RandomAccessIterator dest_first, T&& old_value, T&& new_value);

    template<typename ConstRandomAccessIterator,typename RandomAccessIterator, typename UnaryPredicate, typename T>
    RandomAccessIterator replace_copy_if(ConstRandomAccessIterator first, ConstRandomAccessIterator last, RandomAccessIterator dest_first, UnaryPredicate&& p, T&& new_value);
    ...
    template<typename ConstRandomAccessIterator, typename RandomAccessIterator>
    RandomAccessIterator reverse_copy(ConstRandomAccessIterator first, ConstRandomAccessIterator last, RandomAccessIterator dest_first);
    ...
    template<typename ConstRandomAccessIterator,typename RandomAccessIterator>
    RandomAccessIterator rotate_copy(ConstRandomAccessIterator first, ConstRandomAccessIterator middle, ConstRandomAccessIterator last, RandomAccessIterator dest_first);
    ...
    template<typename ConstRandomAccessIterator1, typename ConstRandomAccessIterator2>
    ConstRandomAccessIterator1 search(ConstRandomAccessIterator1 first1, ConstRandomAccessIterator1 last1, ConstRandomAccessIterator2 first2, ConstRandomAccessIterator2 last2);

    // NOT IMPLEMENTED
    template<typename ConstRandomAccessIterator1, typename ConstRandomAccessIterator2, typename Predicate>
    ConstRandomAccessIterator1 search(ConstRandomAccessIterator1 first1, ConstRandomAccessIterator1 last1, ConstRandomAccessIterator2 first2, ConstRandomAccessIterator2 last2, Predicate&& p);

    // TODO_NOT_IMPLEMENTED: search_n
    template<typename ConstRandomAccessIterator, typename Size, typename T>
    ConstRandomAccessIterator search_n(ConstRandomAccessIterator first, ConstRandomAccessIterator last, Size count, T&& val);

    // NOT IMPLEMENTED
    template<typename ConstRandomAccessIterator, typename Size, typename T, typename Predicate>
    ConstRandomAccessIterator search_n(ConstRandomAccessIterator first, ConstRandomAccessIterator last, Size count, T&& val, Predicate&& p);

    template<typename ConstRandomAccessIterator, typename T>
    bool binary_search(ConstRandomAccessIterator first, ConstRandomAccessIterator last, T&& value);

    template<typename ConstRandomAccessIterator, typename T, typename Compare>
    bool binary_search(ConstRandomAccessIterator first, ConstRandomAccessIterator last, T&& value, Compare&& comp);
    ...
    RandomAccessIterator2 swap_ranges(RandomAccessIterator1 first1, RandomAccessIterator1 last1, RandomAccessIterator2 first2);
